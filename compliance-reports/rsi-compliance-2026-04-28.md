# RSI Compliance Audit — 2026-04-28
...
| iheldtheline.com | **FAIL** | fetched via `blocked` |
...
| bestspacesim.com | **FAIL** | fetched via `blocked` |
| freeflyevent.com | **PASS** | fetched via `requests` |
| pledgemeaning.com | **FAIL** | fetched via `blocked` |
| highestfundedgame.com | **FAIL** | fetched via `blocked` |
| mostfundedgame.com | **FAIL** | fetched via `blocked` |
| o7meaning.com | **FAIL** | fetched via `blocked` |
