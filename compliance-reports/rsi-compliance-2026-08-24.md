# RSI Compliance Audit — 2026-08-24
...
| freeflyevent.com | **WARN** | fetched via `requests` |
...
| `disclaimer` | **PASS** | Fan-site disclaimer detected |
| `non_commercial_ads` | **PASS** | No ad-network references detected |
| `referral_program` | **WARN** | RSI links present but no /enlist?referral=CODE format detected |
